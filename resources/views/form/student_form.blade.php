...
@section('container')
  ...
  <div class="card height-auto">
    <div class="card-body">
        ...
        ?>
                            <select class="form-control select select2" onchange="getClass()" style="width: 100%;" name="StudentClass" id="StudentClass"  required>
        ...
        <input type="text" name="StudentClass" id="StudentClass" class="form-control" readonly>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select select2" style="width: 100%;" name="StudentGender" id="StudentGender" required>
                            <option value="">
                                SELECT
                            </option>
                            <option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select select2" style="width: 100%;" name="StudentReligion" id="StudentReligion" required>
                            <option value="">
                                SELECT
                            </option>
                            <option>
                ...
                <div class="col-md-4 d-none" id="Sgroup" >
                    <div class="form-group">
                        ...
                        <select class="form-control select select2" style="width: 100%;" name="StudentGroup" id="StudentGroup" >
                            <option value="">
                                SELECT
                            </option>
                            <option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select select2" style="width: 100%;" name="StudentStatus" id="StudentStatus" required>
                            <option>
                                Active
                            </option>
                            <option>
...
if($rows[0]->StudentClass=='Nine' || $rows[0]->StudentClass=='Ten'){
?>
getClass();
<?php
}
