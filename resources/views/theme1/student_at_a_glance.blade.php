...
?>
                        <tr>
                            <td align="left" style="border-color:#CCCCCC;border-width:1px;border-style:Solid;font-family:Century Gothic;font-size:9pt;font-weight:bold;width:75px;">{{ class_en_to_bn($class) }}</td>
